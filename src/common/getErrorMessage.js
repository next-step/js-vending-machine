...
const isMinPurchaseValue = value => value < PRODUCT_PRICE.MIN_UNIT || value % PRODUCT_PRICE.MIN_UNIT;
...
const getErrorMessage = (key, value) => {
  ...
  switch (key) {
    ...
    case "product-purchase-amount":
      return isMinPurchaseValue(value) ? ERROR_MESSAGES.INVALID_PRODUCT_CHARGE : "";
    case "quantity":
